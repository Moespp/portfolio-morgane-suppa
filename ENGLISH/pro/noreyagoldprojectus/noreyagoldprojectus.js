...
document.addEventListener('scroll', function() {
    ...
    const startFade2 = 2100; // Position de défilement où l'opacité commence à diminuer
    const endFade2 = 1800; // Position de défilement où l'opacité atteint 0
    const maxScroll = document.documentElement.scrollHeight - window.innerHeight;
...
function toggleMoreText() {
    ...
    if (moreText.style.display === "none") {
        ...
        btn.textContent = "[Reduce]"; // Change le texte du bouton
    } else {
        ...
        btn.textContent = "[More]"; // Change le texte du bouton
    }
}
